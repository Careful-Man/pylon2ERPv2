        ...
        {//otan o xristis pataei eksagogi olon, eksagei ta arthra tis voithitikis listas aftis tis klasis, sto arxeio
            if (getHelpClicked) {
                DialogResult drOk = MessageBox.Show(
                     ...
                     "\nΕΝΗΜΕΡΩΣΗ 12/10/22: \nΑφού δημιουργήσει τα 2 αρχεία, το πρόγραμμα διαγράφει το αρχείο που δεν προορίζεται προς εισαγωγή στο ERP." +
                     "\nΕΝΗΜΕΡΩΣΗ 12/10/22: \nΔιαγράφει το αρχείο κάτι.txt και αφήνει το κάτι_ASCII.txt προς καταχώρηση στο ERP" +
                     "",
        ...
        private void axTextBox_Click(object sender, EventArgs e) {
            if (getHelpClicked) {
                DialogResult drOk = MessageBox.Show(
                     ...
                     "\nΕΝΗΜΕΡΩΣΗ 12/10/22: \nΕπιτρέπει την επιλογή κειμένου στο πεδίο και την εισαγωγή αριθμών χωρίς να χρειαστεί να πατηθεί το πλήκτρο backspace." +
                     "\nΕΝΗΜΕΡΩΣΗ 12/10/22: \nΜετονομασία του πεδίου από \"ΑΧ\" σε \"Κατάστημα\"." +
                     "",
